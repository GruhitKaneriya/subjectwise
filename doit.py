    ...
    while s:
        ...
        if s:
            ...
            for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
                ...
                matches = list(face_distance <= threshold)  # Check if face_distance is within the threshold
                ...
                if True in matches:
                    ...
                    cv2.putText(frame, f"Roll No: {roll_no}", (left, top - 40), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)

                else:  # Handling unrecognized faces
                    name = "Unknown"
                    roll_no = "Not recognized"
                    ...
                    # Draw red rectangle around the unknown face
                    cv2.rectangle(frame, (left, top), (right, bottom), (0, 0, 255), 2)
                    # Display "Not Recognized" message
                    cv2.putText(frame, "Not Recognized", (left, top - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
                    # Optionally, save this unidentified face or trigger any other action you desire
